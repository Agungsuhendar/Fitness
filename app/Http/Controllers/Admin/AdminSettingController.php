...
class AdminSettingController extends Controller
{
    ...
    public function index()
    {
        ...
        $settings = [
            ...
            'hero_subtitle' => Setting::get('hero_subtitle', 'Bimbingan privat 1-on-1 bergaransi cepat bisa! Melayani fitness & personal trainer anak, dewasa pemula (dengan bimbingan trainer privat), khusus wanita/muslimah, serta persiapan tes TNI/POLRI.'),
            ...
            'site_seo_description' => Setting::get('site_seo_description', 'FitLife Gym Jogja profesional & privat di Yogyakarta. Melayani fitness & personal trainer anak, dewasa pemula, khusus wanita/muslimah, & persiapan tes TNI/POLRI. Garansi cepat bisa!'),
            'site_share_image' => Setting::get('site_share_image', 'images/logo.png'),
            'site_footer_about' => Setting::get('site_footer_about', 'Pusat pelatihan & kursus privat fitness terpercaya di Yogyakarta. Menyediakan program khusus anak-anak, dewasa pemula, privat wanita/muslimah, serta kelas intensif persiapan tes TNI, POLRI & Kedinasan.'),
