        ...
        if (Registration::count() === 0) {
            $dummyRegistrations = [
                [
                    ...
                    'program_name' => 'Paket FitLife Fitness & PT Anak',
                    'preferred_location' => 'ApexFitness Sleman HQ',
                    'preferred_schedule' => 'Sabtu & Minggu Pagi (07.00 - 08.30)',
                    'notes' => 'Anak belum pernah belajar fitness, sedikit takut air.',
                    'status' => 'baru',
                ...
                [
                    ...
                    'preferred_location' => 'ApexFitness Seturan Studio',
                ...
                [
                    ...
                    'preferred_location' => 'ApexFitness Kota Jogja',
        ...
        if (TrialBooking::count() === 0) {
            $dummyTrials = [
                [
                    ...
                    'phone' => '081399887766',
                    'program_name' => 'Trial Class FitLife Fitness & PT Anak',
                    'preferred_location' => 'ApexFitness Sleman HQ',
                ...
                [
                    ...
                    'notes' => 'Anak suka befitness tapi belum paham teknik pernapasan.',
                    'status' => 'dikonfirmasi',
                    'created_at' => now()->subDays(1),
                ],
                [
                    ...
                    'notes' => 'Tes kemampuan awal fitness 50 meter gaya bebas.',
                    'status' => 'selesai',
                    'created_at' => now(),
                ],
            ];
