...
class LesFitnessSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $defaultSettings = [
            ...
            'whatsapp_message' => 'Halo Admin FitLife, saya ingin klaim Free Trial 7 Hari & konsultasi program fitness.',
            'site_email' => 'info@fitlife.id',
            'site_phone' => '+62 812-3456-7890',
            'office_address' => 'Jl. Kaliurang Km 5.5 No. 88, Sleman, D.I. Yogyakarta 55281',
            'instagram_url' => 'https://instagram.com/fitlife.id',
            'tiktok_url' => 'https://tiktok.com/@fitlife.id',
            'youtube_url' => 'https://youtube.com/@fitlifeid',
            'site_seo_title' => 'FitLife - Stronger Body, Better Life | Fitness Center Terpercaya di Yogyakarta',
            'site_seo_description' => 'FitLife Yogyakarta. #1 Fitness Center Terpercaya di Yogyakarta dengan bimbingan Personal Trainer profesional bersertifikasi. Trial Gratis 7 Hari Tanpa Komitmen!',
            'site_footer_about' => 'Pusat kebugaran fitness gym & Personal Trainer privat 1-on-1 terpercaya di Yogyakarta. Stronger Body, Better Life.',
            'hero_subtitle' => 'Raih versi terbaik dirimu bersama program latihan dan bimbingan profesional dari trainer berpengalaman.',
            'promo_text' => '🔥 Trial Gratis 7 Hari - Tanpa Komitmen',
