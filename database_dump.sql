...
INSERT INTO `users` (`id`, `name`, `email`, `email_verified_at`, `password`, `remember_token`, `created_at`, `updated_at`, `phone`, `role`, `member_card_id`, `membership_type`, `status`, `branch`, `total_sessions`, `completed_sessions`, `remaining_sessions`, `assigned_coach`, `next_session`, `initial_weight`, `current_weight`, `target_weight`, `initial_bodyfat`, `current_bodyfat`, `muscle_mass`) VALUES (1, 'Admin ApexFitness', 'admin@apexfitness.id', NULL, '$2y$12$Fyn65HemQR0fVOSfMkCHo.trjUFYIPwXSXSXIdt78mhciBfxLmxi2', NULL, '2026-08-05 16:28:50', '2026-08-05 18:16:08', NULL, 'member', NULL, NULL, 'active', NULL, 0, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `users` (`id`, `name`, `email`, `email_verified_at`, `password`, `remember_token`, `created_at`, `updated_at`, `phone`, `role`, `member_card_id`, `membership_type`, `status`, `branch`, `total_sessions`, `completed_sessions`, `remaining_sessions`, `assigned_coach`, `next_session`, `initial_weight`, `current_weight`, `target_weight`, `initial_bodyfat`, `current_bodyfat`, `muscle_mass`) VALUES (2, 'Admin FitLife', 'admin@fitlifecenter.id', NULL, '$2y$12$/ZBLIxwP6xITN62m./dUieG4WHJnzk8nJsX.gD7hwcop6bNnma20y', NULL, '2026-08-05 18:16:08', '2026-08-05 18:16:08', NULL, 'member', NULL, NULL, 'active', NULL, 0, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO `testimonials` (`id`, `name`, `role`, `program`, `rating`, `review`, `avatar`, `video_url`, `is_featured`, `is_approved`, `created_at`, `updated_at`) VALUES (1, 'Bima Perkasa (28 th)', 'Software Engineer (Sleman)', 'Weight Loss & Body Transformation', 5, 'Turun 16 kg dalam 3 bulan! Dulu sering sakit pinggang karena kelamaan duduk koding & BB 88 kg. Dibimbing Coach ApexFitness dengan pola latihan intensif tapi tetep bisa makan nasi. Sekarang BB 72 kg & perut buncit hilang!', 'images/assets/member_bima_avatar.png', 'https://www.youtube.com/embed/5ee8sX_1-9c', 1, 1, '2026-08-05 16:36:59', '2026-08-06 14:28:41');
INSERT INTO `testimonials` (`id`, `name`, `role`, `program`, `rating`, `review`, `avatar`, `video_url`, `is_featured`, `is_approved`, `created_at`, `updated_at`) VALUES (2, 'Rian Ardianto', 'Lulusan Bintara POLRI 2026', 'Strength & Persiapan TNI-POLRI', 5, 'Awalnya pull-up cuma bisa 3x dan lari 12 menit dapet 1800m. Setelah 2 bulan gabung ApexFitness program TNI-POLRI, pull-up tembus 18x presisi & lari tembus 3100m. Nilai kesamaptaan saya dapet 100 sempurna!', 'images/assets/member_bima_avatar.png', 'https://www.youtube.com/embed/xVeXGKPOH58', 1, 1, '2026-08-05 16:36:59', '2026-08-06 14:28:41');
INSERT INTO `testimonials` (`id`, `name`, `role`, `program`, `rating`, `review`, `avatar`, `video_url`, `is_featured`, `is_approved`, `created_at`, `updated_at`) VALUES (3, 'Anisa Rahma, S.Farm', 'Apoteker & Member Wanita', 'Female Fitness & Body Shaping', 5, 'Privasi luar biasa nyaman karena ada area khusus cewek & pelatih wanita yang ramah. Dalam 8 minggu paha & pinggul jadi kencang, lengan tidak gelambir lagi. Berat badan ideal & badan terasa super fit!', 'images/assets/member_anisa_avatar.png', 'https://www.youtube.com/embed/M5cs8a3Bhfg', 1, 1, '2026-08-05 16:36:59', '2026-08-06 14:28:41');
INSERT INTO `testimonials` (`id`, `name`, `role`, `program`, `rating`, `review`, `avatar`, `video_url`, `is_featured`, `is_approved`, `created_at`, `updated_at`) VALUES (4, 'Drs. Supriyanto (49 th)', 'PNS & Pasien Posture Rehab', 'Posture Correction & Rehab', 5, 'Nyeri saraf kejepit di pinggang bawah yang mengganggu tidur selama 2 tahun akhirnya sembuh total setelah terapi latihan fungsional di ApexFitness. Postur berdiri jadi tegap & rasa pegal hilang.', 'images/assets/member_bima_avatar.png', NULL, 1, 1, '2026-08-05 16:36:59', '2026-08-06 14:28:41');
...
INSERT INTO `registrations` (`id`, `name`, `phone`, `email`, `age_category`, `program_name`, `preferred_location`, `preferred_schedule`, `notes`, `status`, `created_at`, `updated_at`) VALUES (1, 'Budi Santoso', '081234567890', 'budi@example.com', 'Dewasa Pemula', 'Weight Loss & Body Transformation', 'ApexFitness Center Sleman (HQ)', 'Pagi Hari (06:00 - 09:00 WIB)', 'Ingin turun BB 10 kg & perbaiki postur', 'pending', '2026-08-05 16:36:59', '2026-08-05 16:36:59');
INSERT INTO `registrations` (`id`, `name`, `phone`, `email`, `age_category`, `program_name`, `preferred_location`, `preferred_schedule`, `notes`, `status`, `created_at`, `updated_at`) VALUES (2, 'Siti Nurhaliza', '081987654321', 'siti@example.com', 'Wanita / Muslimah Privat', 'Female Fitness & Body Shaping', 'Apex Studio Seturan', 'Sore Hari (15:30 - 18:30 WIB)', 'Minta Personal Trainer wanita', 'confirmed', '2026-08-05 16:36:59', '2026-08-05 16:36:59');
...
INSERT INTO `trial_bookings` (`id`, `parent_name`, `participant_name`, `participant_age`, `phone`, `program_name`, `preferred_location`, `trial_date`, `trial_time`, `notes`, `status`, `created_at`, `updated_at`) VALUES (1, 'Bima Perkasa', 'Bima Perkasa', '28 Tahun', '081234567890', 'Weight Loss & Body Transformation', 'ApexFitness Center Sleman HQ', '2026-08-07 16:36:59', '08.00 WIB', 'Mau klaim Free InBody Scan', 'pending', '2026-08-05 16:36:59', '2026-08-05 16:36:59');
...
INSERT INTO `coaches` (`id`, `name`, `title`, `specialty`, `description`, `photo`, `color`, `order`, `is_active`, `created_at`, `updated_at`) VALUES (1, 'Coach Hendra', 'S.Or, CSCS', 'Head PT & Weight Loss Specialist', 'Lulusan Ilmu Keolahragaan UNY & APKI Certified. Pengalaman 10+ tahun melatih 500+ member fat burn & body transformation.', 'images/assets/coach_hendra.webp', '#10b981', 1, 1, '2026-08-05 16:36:59', '2026-08-05 16:36:59');
INSERT INTO `coaches` (`id`, `name`, `title`, `specialty`, `description`, `photo`, `color`, `order`, `is_active`, `created_at`, `updated_at`) VALUES (2, 'Coach Danu', 'APKI Certified', 'Persiapan TNI/POLRI & Muscle Building', 'Mantan instruktur fisik militer. Spesialis drill kalistenik, stamina lari 12 menit, & pull-up presisi nilai 100.', 'images/assets/coach_danu.webp', '#f97316', 2, 1, '2026-08-05 16:36:59', '2026-08-05 16:36:59');
INSERT INTO `coaches` (`id`, `name`, `title`, `specialty`, `description`, `photo`, `color`, `order`, `is_active`, `created_at`, `updated_at`) VALUES (3, 'Coach Rina', 'Pilates & Female Fitness Specialist', 'Female Body Shaping & Glute Workout', 'Personal Trainer wanita khusus member cewek & muslimah. Penguasaan Reformer Pilates & shaping lekuk tubuh.', 'images/assets/coach_rina.webp', '#ec4899', 3, 1, '2026-08-05 16:36:59', '2026-08-05 16:36:59');
INSERT INTO `coaches` (`id`, `name`, `title`, `specialty`, `description`, `photo`, `color`, `order`, `is_active`, `created_at`, `updated_at`) VALUES (4, 'Coach Bima', 'S.Fis, AIFO', 'Posture Rehab & Pain Relief', 'Fisioterapis keolahragaan. Spesialis penanganan bungkuk (Kyphosis), scoliosis ringan, & rehabilitasi pasca cedera.', 'images/assets/coach_bima.webp', '#38bdf8', 4, 1, '2026-08-05 16:36:59', '2026-08-05 16:36:59');
...
INSERT INTO `features` (`id`, `icon`, `title`, `description`, `color`, `order`, `is_active`, `created_at`, `updated_at`) VALUES (1, 'fa-solid fa-certificate', 'Trainer Berlisensi APKI / IFBB', 'Didampingi Personal Trainer profesional tersertifikasi nasional & internasional yang berpengalaman melatih 1000+ member.', '#10b981', 1, 1, '2026-08-05 16:36:59', '2026-08-05 16:36:59');
INSERT INTO `features` (`id`, `icon`, `title`, `description`, `color`, `order`, `is_active`, `created_at`, `updated_at`) VALUES (2, 'fa-solid fa-chart-line', 'InBody 3D Scan & Body Assessment', 'Evaluasi massa otot, % lemak tubuh, dan kadar metabolisme tubuh secara akurat setiap 2 minggu sekali.', '#f97316', 2, 1, '2026-08-05 16:36:59', '2026-08-05 16:36:59');
INSERT INTO `features` (`id`, `icon`, `title`, `description`, `color`, `order`, `is_active`, `created_at`, `updated_at`) VALUES (3, 'fa-solid fa-person-dress', 'Trainer Wanita & Studio Privat', 'Khusus member wanita / muslimah dengan Personal Trainer wanita sabar & area studio gym privat aman 100%.', '#ec4899', 3, 1, '2026-08-05 16:36:59', '2026-08-05 16:36:59');
INSERT INTO `features` (`id`, `icon`, `title`, `description`, `color`, `order`, `is_active`, `created_at`, `updated_at`) VALUES (4, 'fa-solid fa-trophy', 'Garansi Hasil Terukur', 'Program latihan terstruktur, custom meal plan harian, & garansi pemangkasan lemak/pembentukan otot progresif.', '#38bdf8', 4, 1, '2026-08-05 16:36:59', '2026-08-05 16:36:59');
