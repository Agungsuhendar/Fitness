...
<section class="hero-section" style="padding: 4rem 0; background: #070a12; color: white;">
    <div class="container">
        <div style="text-align: center; max-width: 800px; margin: 0 auto;">
            <span class="section-subtitle" style="color: var(--brand-primary, #84cc16); font-weight: 800; text-transform: uppercase; letter-spacing: 1px;">Program Unggulan</span>
            <h1 class="hero-title" style="font-size: 3rem; font-weight: 900; margin-top: 0.5rem; font-family: 'Outfit', sans-serif; color: #ffffff;">Program <span style="color: var(--brand-primary, #84cc16);">FitLife Center</span></h1>
        ...
        <div class="grid-3" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 1.75rem;">
            ...
            <div class="program-card" style="background: #1e293b; border: 1px solid rgba(255,255,255,0.1); border-radius: 1.25rem; overflow: hidden; display: flex; flex-direction: column;">
                <div class="program-thumb" style="position: relative; height: 200px;">
                    ...
                    @if($prog->badge)
                        <span class="program-badge" style="position: absolute; top: 12px; right: 12px; background: var(--brand-primary, #84cc16); color: #ffffff !important; padding: 0.3rem 0.8rem; border-radius: 99px; font-weight: 800; font-size: 0.75rem; text-transform: uppercase;">{{ $prog->badge }}</span>
                    @endif
                </div>
                <div class="program-body" style="padding: 1.5rem; display: flex; flex-direction: column; flex-grow: 1;">
                    ...
                    <div class="program-audience" style="font-size: 0.85rem; color: var(--brand-primary, #84cc16); font-weight: 700; margin-bottom: 0.85rem;">
                    ...
                    <div class="program-footer" style="display: flex; justify-content: space-between; align-items: center; border-top: 1px solid rgba(255,255,255,0.08); padding-top: 1rem; margin-top: auto;">
                        ...
                        <a href="{{ route('program.show', $prog->slug) }}" class="btn btn-outline btn-sm" style="border: 1.5px solid var(--brand-primary, #84cc16); color: var(--brand-primary, #84cc16); padding: 0.5rem 1rem; border-radius: 99px; font-weight: 800; text-decoration: none;">
