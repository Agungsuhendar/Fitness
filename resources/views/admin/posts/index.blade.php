...
<div class="admin-card" style="padding: 1.75rem 2rem; margin-bottom: 2rem;">
    <div style="display: flex; justify-content: space-between; align-items: center; gap: 1rem; flex-wrap: wrap;">
        <div>
            ...
            <p style="color: #cbd5e1; font-size: 0.875rem; margin-top: 0.35rem;">Kelola artikel edukasi tips fitness, parenting, dan persiapan tes TNI POLRI.</p>
        </div>
    ...
    <table class="admin-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="font-weight: 800; color: #ffffff; max-width: 280px;">{{ $post->title }}</td>
                <td>
                ...
                <td style="font-size: 0.875rem; color: #94a3b8; font-weight: 700;">{{ $post->author }}</td>
