...
<section style="background: #060907; padding: 3.5rem 0 6rem; color: white; min-height: 85vh;">
    <div class="container">
        ...
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 2rem; flex-wrap: wrap; gap: 1rem;">
            <div>
                <a href="{{ route('admin.dashboard') }}" style="color: #94a3b8; font-weight: 800; text-decoration: none; display: inline-flex; align-items: center; gap: 0.5rem; font-size: 0.85rem; margin-bottom: 0.5rem;">
            ...
            <div style="display: flex; gap: 1rem;">
                <div style="background: rgba(132,204,22,0.12); border: 1.5px solid #84cc16; padding: 0.65rem 1.25rem; border-radius: 1rem; text-align: right;">
                    <span style="font-size: 0.725rem; color: #84cc16; font-weight: 800; text-transform: uppercase;">TOTAL MEMBER</span>
                    <div style="font-size: 1.35rem; font-weight: 900; color: white;">{{ $totalMembers }} Member</div>
                </div>
                <div style="background: rgba(56,189,248,0.12); border: 1.5px solid #38bdf8; padding: 0.65rem 1.25rem; border-radius: 1rem; text-align: right;">
                    <span style="font-size: 0.725rem; color: #38bdf8; font-weight: 800; text-transform: uppercase;">KUOTA SESI AKTIF</span>
                    <div style="font-size: 1.35rem; font-weight: 900; color: white;">{{ $totalActiveSessions }} Sesi</div>
                </div>
            </div>
        </div>
                ...
                <table style="width: 100%; border-collapse: collapse; text-align: left; font-size: 0.875rem;">
                    ...
                    <tbody style="color: #cbd5e1;">
                        ...
                        <tr style="border-bottom: 1px solid rgba(255,255,255,0.06);">
                            ...
                            <td style="padding: 1rem;">
                                <div style="font-weight: 700; color: white;">{{ $m->membership_type ?: 'VIP Personal Trainer Pass' }}</div>
