<div class="sticky-mobile-bar" id="mobileStickyCtaBar" style="display: flex; gap: 0.35rem; padding: 0.6rem 0.85rem;">
    ...
    <a href="https://wa.me/{{ site_setting('whatsapp_number', '6281234567890') }}?text={{ urlencode(site_setting('whatsapp_message', 'Halo Admin FitLife, saya konsultasi gratis FitLife Gym & PT.')) }}" target="_blank" class="btn btn-whatsapp btn-sm" style="flex: 1; justify-content: center; font-size: 0.76rem; padding: 0.5rem 0.35rem; white-space: nowrap;">
