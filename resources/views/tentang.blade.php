...
<section class="hero-section" style="padding: 4rem 0; background: #070a12; color: white;">
    <div class="container">
        <div style="text-align: center; max-width: 800px; margin: 0 auto;">
            <span class="section-subtitle" style="color: #10b981; font-weight: 800; text-transform: uppercase; letter-spacing: 1px;">Profil Studio Fitness</span>
            <h1 class="hero-title" style="font-size: 3rem; font-weight: 900; margin-top: 0.5rem; font-family: 'Outfit', sans-serif;">Tentang <span style="color: #10b981;">ApexFitness</span> Center</h1>
...
<section class="section" style="background: #0f172a; color: white; padding: 5rem 0;">
    <div class="container">
        <div class="grid-2" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(320px, 1fr)); gap: 2.5rem; align-items: center;">
            <div>
                <span class="section-subtitle" style="color: #10b981; font-weight: 800; text-transform: uppercase; letter-spacing: 1px; font-size: 0.85rem;">Nilai Utama Kami</span>
                <h2 style="font-size: 2.2rem; margin-bottom: 1.35rem; color: #ffffff; font-weight: 900;">Visi & Misi ApexFitness</h2>
                <div style="margin-bottom: 1.75rem;">
                    <h3 style="font-size: 1.25rem; color: #10b981; margin-bottom: 0.5rem; font-weight: 800;"><i class="fa-solid fa-eye"></i> Visi</h3>
            ...
            <div class="glass-card" style="padding: 2.5rem 2rem; text-align: center; background: #1e293b; color: white; border-radius: 1.5rem; border: 1px solid rgba(255,255,255,0.1);">
                ...
                <div class="grid-2" style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.25rem; margin-top: 1.5rem;">
                    <div style="background: rgba(255,255,255,0.05); padding: 1.25rem; border-radius: 1rem; border: 1px solid rgba(255,255,255,0.08);">
                        <div style="font-size: 2.2rem; font-weight: 900; color: #10b981;">10+ Th</div>
...
<section class="section" style="background: #070a12; padding: 5rem 0; color: white;">
    <div class="container">
        <div class="section-header" style="text-align: center; max-width: 700px; margin: 0 auto 3.5rem;">
            <span class="section-subtitle" style="color: #10b981; font-weight: 800; text-transform: uppercase; letter-spacing: 1px; font-size: 0.85rem;">Tim Instruktur</span>
        ...
        <div class="grid-3" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 1.5rem;">
            <div class="glass-card" style="padding: 2rem; text-align: center; background: #0f172a; border: 1px solid rgba(255,255,255,0.1); border-radius: 1.25rem;">
                <div style="width: 80px; height: 80px; border-radius: 50%; overflow: hidden; margin: 0 auto 1rem; background: #10b981; color: white; display: flex; align-items: center; justify-content: center; font-size: 2rem; font-weight: 900;">
                    H
                </div>
                <h3 style="font-size: 1.25rem; color: #ffffff; font-weight: 800;">Coach Hendra, CSCS</h3>
                <div style="color: #10b981; font-weight: 800; font-size: 0.85rem; margin-bottom: 0.75rem;">Head Personal Trainer & Weight Loss Specialist</div>
            ...
            <div class="glass-card" style="padding: 2rem; text-align: center; background: #0f172a; border: 1px solid rgba(255,255,255,0.1); border-radius: 1.25rem;">
                <div style="width: 80px; height: 80px; border-radius: 50%; overflow: hidden; margin: 0 auto 1rem; background: #f97316; color: white; display: flex; align-items: center; justify-content: center; font-size: 2rem; font-weight: 900;">
                    D
                </div>
            ...
            <div class="glass-card" style="padding: 2rem; text-align: center; background: #0f172a; border: 1px solid rgba(255,255,255,0.1); border-radius: 1.25rem;">
                <div style="width: 80px; height: 80px; border-radius: 50%; overflow: hidden; margin: 0 auto 1rem; background: #ec4899; color: white; display: flex; align-items: center; justify-content: center; font-size: 2rem; font-weight: 900;">
                    R
                </div>
        ...
        <div style="text-align: center; margin-top: 3.5rem;">
            <button onclick="openRegistrationModal()" class="btn btn-primary btn-lg" style="background: linear-gradient(135deg, #10b981 0%, #059669 100%); border: none; padding: 0.9rem 2.2rem; font-weight: 800; border-radius: 99px;">
                <i class="fa-solid fa-paper-plane"></i> Konsultasikan Pilihan Trainer Anda
            </button>
        </div>
    </div>
</section>
