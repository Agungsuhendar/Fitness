...
@section('title', 'Hubungi ApexFitness Center & Personal Training Studio')
@section('meta_description', 'Kontak resmi ApexFitness Center Yogyakarta. Customer service WhatsApp, alamat cabang studio gym, jam operasional 06.00 - 22.00 WIB.')

@section('content')
<section class="hero-section" style="padding: 4rem 0; background: #070a12; color: white;">
    <div class="container">
        <div style="text-align: center; max-width: 800px; margin: 0 auto;">
            <span class="section-subtitle" style="color: #10b981; font-weight: 800; text-transform: uppercase; letter-spacing: 1px;">Customer Care</span>
            <h1 class="hero-title" style="font-size: 3rem; font-weight: 900; margin-top: 0.5rem; font-family: 'Outfit', sans-serif;">Hubungi <span style="color: #10b981;">ApexFitness</span></h1>
        ...
        <div class="grid-2" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(320px, 1fr)); gap: 3rem;">
            ...
            <div>
                <div class="glass-card" style="padding: 2.25rem; background: #1e293b; border: 1px solid rgba(255,255,255,0.1); border-radius: 1.25rem; margin-bottom: 2rem;">
                    ...
                    <div style="display: flex; gap: 1rem; margin-bottom: 1.25rem; align-items: center;">
                        <div style="width: 46px; height: 46px; background: rgba(16, 185, 129, 0.15); color: #10b981; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 1.25rem;">
                    ...
                    <div style="display: flex; gap: 1rem; margin-bottom: 1.25rem; align-items: center;">
                        <div style="width: 46px; height: 46px; background: rgba(249, 115, 22, 0.15); color: #f97316; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 1.25rem;">
            ...
            <div>
                <div class="glass-card" style="padding: 2.25rem; background: #1e293b; border: 1px solid rgba(255,255,255,0.1); border-radius: 1.25rem;">
                    ...
                    <form action="{{ route('lead.register') }}" method="POST">
                        ...
                        <button type="submit" class="btn btn-primary" style="width: 100%; background: linear-gradient(135deg, #10b981 0%, #059669 100%); border: none; padding: 0.85rem; font-weight: 800; border-radius: 0.75rem; color: white;">
                            <i class="fa-solid fa-paper-plane"></i> Kirim Pesan Konsultasi
                        </button>
                    </form>
                </div>
            </div>
